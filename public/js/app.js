(function() {
  ...
  var states = [
    'A song is already playing, please wait...',
  ...
  var chooseNickname = function(msg) {
    ...
    var html = [
      ...
      '<small>You are joining the ' + roomname + ' room</small>',
      '</div>',
      '<form role="form">',
      ...
      '</div>',
      '<input class="form-control" placeholder="@nickname" input id="login" maxlength="15" type="text" name="nickname">',
      '</div>',
      '</div>',
      '<div class="text-center">',
      '<button id="join" type="button" class="btn btn-primary my-4">Enter</button>',
      '</div>',
      '</form>',
      '</div>',
      '</div>',
  ...
  var gameOver = function(podium) {
    var html = [
      '<div class="modal-dialog modal-xl modal-danger modal-dialog-centered modal-" role="document">',
      '<div class="modal-content bg-gradient-danger">',
      '<div class="modal-header">',
      '<h6 class="modal-title" id="modal-title-notification">Game over!</h6>',
    ...
    html.push('<button type="button" class="btn btn-white">Ok, Got it</button>');
    html.push('A new game will start in <span> </span>_seconds');
    html.push('</div>');
